#############################################################################
# Makefile for building: handwriter_detection
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  handwriter_detection.pro
# Template: app
# Command: /opt/Qt5.2.1/5.2.1/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile handwriter_detection.pro
#############################################################################
...
INCPATH       = -I/opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/linux-g++ -I. -I/usr/local/include -I/opt/Qt5.2.1/5.2.1/gcc_64/include -I/opt/Qt5.2.1/5.2.1/gcc_64/include/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-rpath,/opt/Qt5.2.1/5.2.1/gcc_64 -Wl,-rpath,/opt/Qt5.2.1/5.2.1/gcc_64/lib
LIBS          = $(SUBLIBS) -I/usr/local/include -ltesseract -L/usr/lib/x86_64-linux-gnu -L/usr/local/lib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_ml -L/opt/Qt5.2.1/5.2.1/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
...
DIST          = /opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/features/spec_pre.prf \
		...
		handwriter_detection.pro \
		handwriter_detection.pro
QMAKE_TARGET  = handwriter_detection
...
Makefile: handwriter_detection.pro /opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/common/shell-unix.conf \
		/opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt5.2.1/5.2.1/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile handwriter_detection.pro
...
dist: 
	@test -d .tmp/handwriter_detection1.0.0 || mkdir -p .tmp/handwriter_detection1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/handwriter_detection1.0.0/ && $(COPY_FILE) --parents mnist.h .tmp/handwriter_detection1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/handwriter_detection1.0.0/ && (cd `dirname .tmp/handwriter_detection1.0.0` && $(TAR) handwriter_detection1.0.0.tar handwriter_detection1.0.0 && $(COMPRESS) handwriter_detection1.0.0.tar) && $(MOVE) `dirname .tmp/handwriter_detection1.0.0`/handwriter_detection1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/handwriter_detection1.0.0
